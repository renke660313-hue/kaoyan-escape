...
import { BookOpen, Phone, Key, ArrowRight } from 'lucide-react';
...
export function Login() {
    ...
    if (phone) {
      try {
        ...
        if (savedUser) {
          ...
          setIsExistingUser(parsedUser.phone === phone);
        } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // 只有新用户才需要验证激活码
    if (!isExistingUser && activationCode.length < 6) {
      setError('请输入有效的激活码');
      setIsLoading(false);
      return;
    }

    await login(phone, activationCode);
    // login 函数现在总是返回 true，所以不需要检查返回值
    setIsLoading(false);
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">考研单词出逃计划</h1>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full px-12 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent relative z-10"
                  maxLength={11}
